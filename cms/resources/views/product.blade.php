        ...
        <div class="row s_product_inner">
                ...
                <div class="owl-carousel owl-theme s_Product_carousel">
                    <div class="single-prd-item">
                        <? if (empty($product->image)) {?>
                            <img class="img-fluid" src="<?=asset('img/product/product0.jpg');?>" alt="">
                        <? } else {?>
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    <h3>{{$product->name}}</h3>
                    <h3>ID продукта: {{$id}}</h3>
                    <h2>{{$product->price}} руб.</h2>
                    <ul class="list">
                        <li><a class="active" href="{{ route('category', $product->category->code) }}"><span>Категория</span> : {{$product->category->name}}</a></li>
                        <li><a><span>Доступность</span> : В наличии</a></li>
                    </ul>
                    <p>{{$product->description}}</p>
                    <div class="product_count">

                        <button onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst )) result.value++;return false;"
                                class="increase items-count" type="button" style="transform: rotate(90deg)!important;"><i class="ti-angle-left" ></i></button>
                        <label for="qty">Количество:</label><input type="text" name="qty" id="sst" size="2" maxlength="12" value="1" title="Количество:" class="input-text qty" style="margin-right: 25px;">
                        <button onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst ) &amp;&amp; sst > 0 ) result.value--;return false;"
                                class="reduced items-count" type="button" style="transform: rotate(90deg)!important;"><i class="ti-angle-right"></i></button>
                    ...
                    @else
                           <a class="button primary-btn">Недоступно</a>
                    @endif
