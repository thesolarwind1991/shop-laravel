                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" name="code" id="code"
                               <?//value="@isset($product)?{{ $product->code }}:{{old('code')}} @endisset">?>
                ...
                <br>
                    ...
                    <div class="input-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" name="count" id="cont"
                    ...
                    <div class="col-sm-6">
                       @include('layouts.error', ['fieldName' => 'description'])
                        <textarea name="description" id="description" cols="72"
                                  rows="7">{{isset($product)?$product->description:old('description')}}</textarea>
                    </div>
                </div>
                <!--<br>
                <div class="input-group row">
